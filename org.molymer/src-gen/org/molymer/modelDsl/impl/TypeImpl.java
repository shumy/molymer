 ...
 * <ul>
 *   <li>{@link org.molymer.modelDsl.impl.TypeImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeImpl extends ElementImpl implements Type
{
  ...
  {
    return ModelDslPackage.Literals.TYPE;
  }
  ...
  public EList<AnnotationGroup> getAnnotations()
  {
    if (annotations == null)
    {
      annotations = new EObjectContainmentEList<AnnotationGroup>(AnnotationGroup.class, this, ModelDslPackage.TYPE__ANNOTATIONS);
    }
    return annotations;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ModelDslPackage.TYPE__ANNOTATIONS:
